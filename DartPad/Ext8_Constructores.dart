...
void main() {
  ...
  // CASO 2: Persona que fue trabajador del hospital, y luego paciente
  ...
  // CASO 3: Nuevo paciente que ha fallecido
  final juanLopez = Person(
    ...
    gender: 'Masculino',
    bloodGroup: 'B+',
    curp: 'LOMJ890505HDFTRN09',
    birthdate: DateTime(1989, 5, 5),
    isActive: true,
    createdAt: DateTime(2022, 10, 26, 11, 05, 16),
  );
  ...
  registrarDefuncion(paciente3);
  print(paciente3);
}

// Función para registrar la defunción de un paciente
void registrarDefuncion(Paciente paciente) {
  paciente.estatusVida = 'Finado';
